...
| **upcoming-news.js** | `C:\Users\Admin\panda-dashboard\pages\api\upcoming-news.js` | 111 | **NEW** — HIGH impact news in next 60 min + affected pairs |
...
| `admin_brain` | 18 | **NEW** — Boss-G personal brain (preferences, rules, coaching, patterns) |
| `pdr_cache` | 21 | **NEW** — Per-symbol PDR strength cache (symbol PK, 15-min TTL) |
