...
input bool   TestMode              = false;     // USE pe_ PREFIX - safe for side-by-side testing
...
// Panel state
string PanelPrefix   = "PandaFullV3_";
string BoxPrefix     = "PandaFullV3Box_";
string STPrefix      = "PandaFullV3ST_";
...
void DrawPanel()
{
   ...
   string titleText = TestMode ? "PANDA FULL V3 INDICATOR" : "PANDA FULL V3 INDICATOR";
...
void HidePanel()
{
   ...
   CreateLabel(PanelPrefix + "mini_label", x + 8, y + 5, "PANDA FULL V3 INDICATOR", C'0,180,255', 9, "Arial Bold");
