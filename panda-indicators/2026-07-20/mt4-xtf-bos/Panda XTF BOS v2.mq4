//+------------------------------------------------------------------+
//|  Panda XTF BOS v2                                                 |
//|  v2 changes vs v1: small box = last 5 TRADING days (weekends       |
//|  excluded); BOS + Panda-Lines flip arrows drawn across history;    |
//|  clearer arrow markers. Scoring/box logic otherwise unchanged.     |
...
int OnInit()
{
   ...
   IndicatorShortName("Panda XTF BOS v2");
