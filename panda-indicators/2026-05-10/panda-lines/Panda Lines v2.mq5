//+------------------------------------------------------------------+
//| Panda Lines v2 for MetaTrader 5                                  |
...
string ObjPrefix = "PandaLinesV2_";

int OnInit()
{
   IndicatorSetString(INDICATOR_SHORTNAME, "Panda Lines v2");
...
void DrawAllSRZones(const datetime &time[], const int rates_total)
{
   ...
   datetime time_right = time[0] + PeriodSeconds(_Period) * 50;
