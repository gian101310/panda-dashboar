...
export const INDICATOR_PRODUCTS = [
  ...
  },
  {
    ...
    requestable: true,
    publicDownload: true,
    fileName: 'panda-dashboard-overlay-mt4-licensed.zip',
    downloadPath: '/downloads/panda-dashboard-overlay-mt4-licensed.zip',
    installNote: 'Unzip, copy the overlay .ex4 into MQL4/Indicators and the feed EA .ex4 into MQL4/Experts, allow WebRequest for https://pandaengine.app, then attach the feed EA to one chart and the overlay to any charts. Full steps inside the package.',
  },
  {
    ...
    requestable: true,
    publicDownload: true,
    fileName: 'panda-dashboard-overlay-mt5-licensed.zip',
    downloadPath: '/downloads/panda-dashboard-overlay-mt5-licensed.zip',
    installNote: 'Unzip, copy the overlay .ex5 into MQL5/Indicators and the feed EA .ex5 into MQL5/Experts, allow WebRequest for https://pandaengine.app, then attach the feed EA to one chart and the overlay to any charts. Full steps inside the package.',
  },
];
