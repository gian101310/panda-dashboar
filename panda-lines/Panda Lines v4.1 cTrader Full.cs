...
namespace cAlgo.Indicators
{
    ...
    public class Panda_Lines_v4_1_Full : Indicator
    {
        // ============================================================
        ...
        private void DrawAllSRZones(int index)
        {
            ...
            DateTime timeLeft = Bars.OpenTimes[Math.Max(0, index - SR_ExtendLeft)];
            DateTime timeRight = Bars.OpenTimes[index].AddSeconds(
                (Bars.OpenTimes[index] - Bars.OpenTimes[Math.Max(0, index - 1)]).TotalSeconds * 50);
