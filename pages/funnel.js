        ...
        <section style={{ ...S.section, padding: '80px 24px', maxWidth: 1100, margin: '0 auto' }}>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 60, alignItems: 'center' }} className="deep-grid">
            ...
            <div style={{ background: 'linear-gradient(135deg,#0a0e1a,#0e1525)', border: '1px solid rgba(0,255,159,0.12)', borderRadius: 16, padding: '32px 28px', boxShadow: '0 20px 60px rgba(0,0,0,0.4)' }}>
              <div style={{ fontFamily: mono, fontSize: 9, color: '#445566', letterSpacing: 3, marginBottom: 24 }}>STRENGTH ANALYSIS · REAL-TIME</div>
              {[
                ...
                return <div key={i} style={{ marginBottom: i < 2 ? 20 : 0 }}>
                  <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 8 }}>
                    <span style={{ fontFamily: orb, fontSize: 14, fontWeight: 700, color: '#e8eaf0', letterSpacing: 2 }}>{r.pair}</span>
                  ...
                  <div style={{ fontFamily: mono, fontSize: 8, color: '#445566', letterSpacing: 1, marginTop: 4 }}>{r.label}</div>
                </div>;
              })}
              <div style={{ marginTop: 20, fontFamily: mono, fontSize: 9, color: '#445566', letterSpacing: 1, textAlign: 'center' }}>MULTI-TIMEFRAME · 21 PAIRS · EVERY 5 MIN</div>
            </div>
            {/* Copy */}
            <div>
        ...
        <section style={{ ...S.section, padding: '40px 24px 80px', maxWidth: 1100, margin: '0 auto' }}>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 60, alignItems: 'center' }} className="deep-grid">
            ...
            <div style={{ background: 'linear-gradient(135deg,#0a0e1a,#0e1525)', border: '1px solid rgba(0,180,255,0.12)', borderRadius: 16, padding: '32px 28px', boxShadow: '0 20px 60px rgba(0,0,0,0.4)' }}>
              <div style={{ fontFamily: mono, fontSize: 9, color: '#445566', letterSpacing: 3, marginBottom: 24 }}>MOMENTUM LIFECYCLE</div>
              {[
                ...
                <div key={i} style={{ marginBottom: i < 4 ? 16 : 0 }}>
                  <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 6 }}>
                    ...
                    <span style={{ fontFamily: mono, fontSize: 9, color: '#445566' }}>{r.desc}</span>
                  </div>
              ...
              <div style={{ marginTop: 20, fontFamily: mono, fontSize: 9, color: '#445566', letterSpacing: 1, textAlign: 'center' }}>REAL-TIME CLASSIFICATION · EVERY CYCLE</div>
            </div>
          </div>
        </section>
