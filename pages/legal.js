...
function FAQContent() {
  const faqs = [
    ...
    { q: 'What\'s the difference between Pro and Elite?', a: 'Pro ($49/mo or $499 lifetime — launch pricing) adds the Panel tab, full data table, valid setups, Panda AI assistant, and Research tab. Elite ($99/mo or $999 lifetime — launch pricing) unlocks everything — including the Overview, Signal Logs, Spike alerts, Trading Journal, Chart tab, and custom MT4/MT5 indicators.' },
