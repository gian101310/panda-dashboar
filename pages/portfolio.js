        ...
        <section id="s-data">
          ...
          <div className="data-grid">
            {[
              ...
              { val: "1.8", suf: "K+", label: "Resolved Signals",  note: "BB and INTRA signals with entry, peak, close reason, session, box trend, and PDR at open." },
              { val: "3.9", suf: "K+", label: "Signal Tracker",    note: "Full signal lifecycle tracking. Session, box, PDR, confidence at open. 50+ days collected." },
              { val: "28",  suf: "",   label: "AI Memory Records", note: "Signal + journal + pattern findings. Generated by agents, persisted in Supabase." },
