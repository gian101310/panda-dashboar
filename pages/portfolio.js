      ...
      <div className="container">
        ...
        <section id="s-arch">
          ...
          <div className="arch-grid">
            {[
              ...
              { color: "var(--amber)", layer: "SaaS Product",    name: "Monetization Layer",    tags: [["3 Tiers","amber"],["Telegram","amber"],["Admin Panel","dim"]], desc: "Starter (free trial) / Pro AED 49 / Elite AED 99. Landing page, pricing funnel, approval flow. Telegram bot auto-registers free users and delivers credentials. Admin panel with user management, per-tier feature gating, and payment links." },
            ].map((cell, i) => (
        ...
        <section id="s-cap">
          ...
          <div className="cap-grid">
            {[
              ...
              { icon: "🧠", title: "Persistent AI Memory",          desc: "Specialized agents mine signal and trade databases to produce durable memory records. A weekly revalidation job recomputes key findings as samples grow and retires claims that no longer match current evidence.", tags: [["144+ Memory Records","green"],["Fresh Samples","green"],["Auto-Revalidation","dim"]] },
        ...
        <section id="s-data">
          ...
          <div className="data-grid">
            {[
              { val: "4.7", suf: "K+", label: "Resolved Signals",  note: "BB and INTRA results with entry, peak, close reason, session, box trend, and PDR context." },
              { val: "11.6", suf: "K+", label: "Signal Tracker",    note: "Full signal lifecycle tracking with session, box, PDR, and confidence captured at open." },
              { val: "144",  suf: "+",   label: "AI Memory Records", note: "Signal, journal, pattern, and lifecycle findings generated by agents and persisted in Supabase." },
              { val: "1",  suf: "×", label: "Weekly Revalidation", note: "Core edge claims are recomputed weekly so larger samples replace old headline statistics." },
              { val: "21",  suf: "",   label: "Tracked Pairs",     note: "Full coverage: AUD, CAD, EUR, GBP, JPY, NZD, USD crosses. Gap scores every cycle." },
              { val: "100",  suf: "%",  label: "Auditable Findings", note: "Every performance finding includes its sample size and can be retired when current data no longer supports it." },
            ].map((d, i) => (
              <ScrollFade key={i} delay={i * 50}>
        ...
        <section id="s-pso">
          ...
          <div className="pso-grid">
            {[
              ...
              { cls: "pso-label-o", lbl: "Outcome",  title: "Quantified edges, identified leaks, and claims that stay accountable", body: "Findings are extracted from real data with sample sizes attached. Weekly revalidation now flags headline statistics that decay as more signals resolve, keeping AI memory aligned with current evidence." },
            ].map((p, i) => (
