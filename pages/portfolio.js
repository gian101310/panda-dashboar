        ...
        <section id="s-arch">
          ...
          <div className="arch-grid">
            {[
              ...
              { color: "var(--amber)", layer: "SaaS Product",    name: "Monetization Layer",    tags: [["3 Tiers","amber"],["Telegram","amber"],["Admin Panel","dim"]], desc: "Starter (free trial) / Pro $49 / Elite $99. Landing page, pricing funnel, approval flow. Telegram bot auto-registers free users and delivers credentials. Admin panel with user management, per-tier feature gating, and payment links." },
            ].map((cell, i) => (
