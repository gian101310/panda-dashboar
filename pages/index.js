...
const FEATURES = [
  { icon: '⚡', title: 'LIVE SIGNALS', desc: 'Automated BUY/SELL signals generated every 5 minutes with multi-strategy validation and real-time bias detection.' },
  { icon: '🎯', title: 'ADVANCED CURRENCY SCORING', desc: 'Proprietary modified scoring across D1, H4 & H1 timeframes. Gap analysis, momentum states, and confidence tiers — all computed automatically.' },
  { icon: '📊', title: 'DEEP ANALYTICS', desc: 'Momentum heatmaps, spike detection, currency strength charts, and full signal history logging across all 21 pairs.' },
  { icon: '🔒', title: 'PRIVATE TRADE JOURNAL', desc: 'Track your trades with personal credentials. Import from cTrader or CSV — your data stays yours.' },
];

const STATS = [
  { value: '21', label: 'PAIRS TRACKED' },
  { value: '5min', label: 'SIGNAL CYCLE' },
  { value: 'LIVE', label: 'SIGNALS' },
  { value: '3x', label: 'TIMEFRAME SCORING' },
];
      ...
      <div style={{ background: bg, color: '#e8eaf0', minHeight: '100vh', position: 'relative', overflow: 'hidden' }}>
        ...
        <section id="features" style={{ position: 'relative', zIndex: 1, padding: '80px 24px', maxWidth: 1000, margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: 60 }}>
            <div style={{ fontFamily: mono, fontSize: 10, letterSpacing: 5, color: '#00b4ff', marginBottom: 12 }}>LIVE SIGNALS · ADVANCED SCORING</div>
        ...
        <footer style={{ position: 'relative', zIndex: 1, borderTop: '1px solid #1a2540', padding: '40px 24px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: 16, maxWidth: 1000, margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: 20 }}>
            ...
            <a href="/login" style={{ fontFamily: mono, fontSize: 10, letterSpacing: 2, color: '#445566', textDecoration: 'none' }}>LOGIN</a>
          </div>
        </footer>
      </div>
